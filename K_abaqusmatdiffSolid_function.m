...
function [] = K_abaqusmatdiffSolid_function(flag, layup,t_Hres,t_overmat,E1UD,E1BIAX,E2UD,E2BIAX,E3UD,E3BIAX,V12UD,V12BIAX,V13UD,V13BIAX,V23UD,V23BIAX,G12UD,G12BIAX,G13UD,G13BIAX,G23UD,G23BIAX,first_Step,Tperiod,Min_incr,Max_incr,Viscosity,E1RESIN,V12RESIN,E1UD_EXTRA,E1BIAX_EXTRA,E2UD_EXTRA,E2BIAX_EXTRA,E3UD_EXTRA,E3BIAX_EXTRA,V12UD_EXTRA,V12BIAX_EXTRA,V13UD_EXTRA,V13BIAX_EXTRA,V23UD_EXTRA,V23BIAX_EXTRA,G12UD_EXTRA,G12BIAX_EXTRA,G13UD_EXTRA,G13BIAX_EXTRA,G23UD_EXTRA,G23BIAX_EXTRA)
...
LineText = '**--------------------------------------'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Element, type=CPE4, Elset=Eresin';
fprintf(fileID, '%s\r\n', LineText); 
...
if (mat_change == 1) && (flag==0)
    ...
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = '*Solid Section, elset=EPARENTUD, orientation=Ori-5, material=UDMATERIAL1'; 
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = ','; 
    ...
    fprintf(fileID, '%s\r\n', LineText);
    LineText = '*Solid Section, elset=ERESIN, orientation=Ori-3, material=RESIN'; 
    fprintf(fileID, '%s\r\n', LineText); 
    ...
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = '*Solid Section, elset=Eresinrich, orientation=Ori-9, material=RESIN'; 
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = ','; 
    fprintf(fileID, '%s\r\n', LineText);
    ...
    if (flag==0)     
        ...
        LineText = '3, 0.'; 
        fprintf(fileID, '%s\r\n', LineText);
        LineText = '** Section: Section-3-EREPAIRUD1'; 
        fprintf(fileID, '%s\r\n', LineText);
        LineText = '*Solid Section, elset=EREPAIRUD1, orientation=Ori-7, material=UDMATERIAL1'; 
        fprintf(fileID, '%s\r\n', LineText);
        LineText = ','; 
        ...
        LineText = '3, 0.'; 
        fprintf(fileID, '%s\r\n', LineText); 
        LineText = '** Section: Section-4-EREPAIRBIAX1'; 
        fprintf(fileID, '%s\r\n', LineText); 
        LineText = '*Solid Section, elset=EREPAIRBIAX1, orientation=Ori-6, material=BIAXMATERIAL1'; 
        fprintf(fileID, '%s\r\n', LineText); 
        LineText = ','; 
        fprintf(fileID, '%s\r\n', LineText);
