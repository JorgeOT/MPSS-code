...
LineText = '*Elastic, type=ENGINEERING CONSTANTS'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = ' 3.90E+10, 1.30E+10, 1.30E+10,     0.205,    0.205,    0.349, 5.40E+09, 3.40E+09'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = ' 3.40E+09,';
fprintf(fileID, '%s\r\n', LineText);
...
LineText = '*Elastic, type=ENGINEERING CONSTANTS'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = ' 1.25E+10, 1.25E+10, 1.25E+10,     0.498,    0.498,    0.498, 1.03E+10, 1.03E+10'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = ' 1.03E+10,'; 
fprintf(fileID, '%s\r\n', LineText);
