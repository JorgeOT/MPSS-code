function [S22,S12,LE22,LE12]=Read_ODB_outputs_ele_function3(namefile,elset)
%clear all
%close all
%namefile=('CASE_A');
debug = 0;
...
while ( ~feof(fidd) )
    ...
    if(regexpi(tline, 'E L E M E N T   O U T P U T')>0)
        ...
        if (regexpi(tline, 'MAXIMUM')>0) %For elements, replace 'N O D E   O U T P U T'  by 'E L E M E N T   O U T P U T'
                    ...
                    data_f = sscanf(tline, '%e %e %e %e' , [1,4]);                  
        end
        ...
        if (regexpi(tline, 'MINIMUM')>0) %For elements, replace 'N O D E   O U T P U T'  by 'E L E M E N T   O U T P U T'
                    ...
                    data_f2 = sscanf(tline, '%e %e %e %e' , [1,4]);                  
        end
...
S22 = [data_f(1),data_f2(1)];
S12 = [data_f(2),data_f2(2)];
LE22 = [data_f(3),data_f2(3)];
LE12 = [data_f(4),data_f2(4)];
