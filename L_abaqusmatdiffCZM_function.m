...
function [] = L_abaqusmatdiffCZM_function(V12RESIN,E1RESIN,I_o,I_R,Damstab,t_Vres,flag, layup,t_Hres,t_overmat,E1UD,E1BIAX,E2UD,E2BIAX,E3UD,E3BIAX,V12UD,V12BIAX,V13UD,V13BIAX,V23UD,V23BIAX,G12UD,G12BIAX,G13UD,G13BIAX,G23UD,G23BIAX,first_Step,Tperiod,Min_incr,Max_incr,Viscosity,E1UD_EXTRA,E1BIAX_EXTRA,E2UD_EXTRA,E2BIAX_EXTRA,E3UD_EXTRA,E3BIAX_EXTRA,V12UD_EXTRA,V12BIAX_EXTRA,V13UD_EXTRA,V13BIAX_EXTRA,V23UD_EXTRA,V23BIAX_EXTRA,G12UD_EXTRA,G12BIAX_EXTRA,G13UD_EXTRA,G13BIAX_EXTRA,G23UD_EXTRA,G23BIAX_EXTRA,Daminit_UD,Daminit_UD_DIFF,Daminit_BIAX,Daminit_BIAX_DIFF,Daminit_Resin1,Daminit_Resin2,Daminit_Resin3,Damev_UD,Damev_BIAX,Damev_Resin,Frac_UD1,Frac_UD2,Frac_UD3,Frac_BIAX1,Frac_BIAX2,Frac_BIAX3,Frac_Resin1,Frac_Resin2,Frac_Resin3,Frac_UD1_DIFF,Frac_UD2_DIFF,Frac_UD3_DIFF,Frac_BIAX1_DIFF,Frac_BIAX2_DIFF,Frac_BIAX3_DIFF,Knn,Kss,Ktt,Damev_UD_DIFF,Damev_BIAX_DIFF)
...
if mat_change == 1  
    ...
    LineText = '**--------------------------------------'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineTextloop = '*Element, type=CPE4, Elset=ErepairUD1';
    fprintf(fileID, '%s\r\n', LineTextloop);
    ...
    LineText = '**--------------------------------------'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineTextloop = '*Element, type=CPE4, Elset=ErepairBIAX1';
    fprintf(fileID, '%s\r\n', LineTextloop);
...
if (flag==0)
    ...
    LineText = '**--------------------------------------'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineTextloop = '*Element, type=CPE4, Elset=ErepairUD';
    fprintf(fileID, '%s\r\n', LineTextloop); 
    ...
    LineText = '**--------------------------------------'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineTextloop = '*Element, type=CPE4, Elset=ErepairBiax';
    fprintf(fileID, '%s\r\n', LineTextloop); 
    for m = 1:length(Node_Reploc)
        for n  = 1:length(Node_Reploc{m,1})
            % Layer name
...
if (mat_change == 1) && (flag==0)
    if over_lam == 1 && t_overmat == biax
        ...
        fprintf(fileID, '%s\r\n', LineText); 
        LineText = '*Solid Section, elset=Eoverlam, orientation=Ori-8, material=BIAXMATERIAL1'; 
        fprintf(fileID, '%s\r\n', LineText); 
        LineText = ','; 
        fprintf(fileID, '%s\r\n', LineText);        
            ...
            LineText = '** Section: Section-5-Eoverlam'; 
            fprintf(fileID, '%s\r\n', LineText); 
            LineText = '*Solid Section, elset=Eoverlam, orientation=Ori-8, material=UDMATERIAL1'; 
            fprintf(fileID, '%s\r\n', LineText); 
            LineText = ','; 
            fprintf(fileID, '%s\r\n', LineText);
        end       
    ...
    fprintf(fileID, '%s\r\n', LineText);
    LineText = '*Solid Section, elset=EREPAIRUD1, orientation=Ori-7, material=BIAXMATERIAL1'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineText = ','; 
    ...
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = '*Solid Section, elset=EREPAIRBIAX1, orientation=Ori-6, material=UDMATERIAL1'; 
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = ','; 
    fprintf(fileID, '%s\r\n', LineText);
    ...
    LineText = '** Section: Section-3-EREPAIRBIAX1'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineText = '*Solid Section, elset=EREPAIRBIAX1, orientation=Ori-7, material=BIAXMATERIAL1'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineText = ','; 
    end
    ...
    LineText = '** Section: Section-4-EREPAIRUD1'; 
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = '*Solid Section, elset=EREPAIRUD1, orientation=Ori-6, material=UDMATERIAL1'; 
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = ','; 
    fprintf(fileID, '%s\r\n', LineText);
    end
    ...
    if (flag==0)     
        ...
        fprintf(fileID, '%s\r\n', LineText);
        LineText = '*Solid Section, elset=EREPAIRUD, orientation=Ori-7, material=UDMATERIAL1'; 
        fprintf(fileID, '%s\r\n', LineText);
        LineText = ','; 
        ...
        fprintf(fileID, '%s\r\n', LineText); 
        LineText = '*Solid Section, elset=EREPAIRBIAX, orientation=Ori-6, material=BIAXMATERIAL1'; 
        fprintf(fileID, '%s\r\n', LineText); 
        LineText = ','; 
        fprintf(fileID, '%s\r\n', LineText);
...
LineText = '*Material, name=UDMATERIAL1'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Damage Initiation, criterion=MAXPS'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = strcat(' ',num2str(Daminit_UD_DIFF),','); %Maximum principal stress at damage initiation.
fprintf(fileID, '%s\r\n', LineText);
LineText = strcat('*Damage Evolution, type=ENERGY, mixed mode behavior=BK, power=',num2str(Damev_UD_DIFF));  
fprintf(fileID, '%s\r\n', LineText);
LineText = strcat(num2str(Frac_UD1_DIFF),',',num2str(Frac_UD2_DIFF),',',num2str(Frac_UD3_DIFF)); 
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Elastic, type=ENGINEERING CONSTANTS'; 
fprintf(fileID, '%s\r\n', LineText);
LineText =  strcat(num2str(E1UD_EXTRA),',',num2str(E2UD_EXTRA),',',num2str(E3UD_EXTRA),',',num2str(V12UD_EXTRA),',',num2str(V13UD_EXTRA),',',num2str(V23UD_EXTRA),',',num2str(G12UD_EXTRA),',',num2str(G13UD_EXTRA)); 
fprintf(fileID, '%s\r\n', LineText);
LineText = num2str(G23UD_EXTRA);
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Material, name=BIAXMATERIAL1'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Damage Initiation, criterion=MAXPS'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = strcat(' ',num2str(Daminit_BIAX_DIFF),','); %Maximum principal stress at damage initiation.
fprintf(fileID, '%s\r\n', LineText);
LineText = strcat('*Damage Evolution, type=ENERGY, mixed mode behavior=BK, power=',num2str(Damev_BIAX_DIFF)); 
fprintf(fileID, '%s\r\n', LineText);
LineText = strcat(num2str(Frac_BIAX1_DIFF),',',num2str(Frac_BIAX2_DIFF),',',num2str(Frac_BIAX3_DIFF)); 
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Elastic, type=ENGINEERING CONSTANTS'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = strcat(num2str(E1BIAX_EXTRA),',',num2str(E2BIAX_EXTRA),',',num2str(E3BIAX_EXTRA),',',num2str(V12BIAX_EXTRA),',',num2str(V13BIAX_EXTRA),',',num2str(V23BIAX_EXTRA),',',num2str(G12BIAX_EXTRA),',',num2str(G13BIAX_EXTRA)); 
fprintf(fileID, '%s\r\n', LineText);
LineText = num2str(G23BIAX_EXTRA);
fprintf(fileID, '%s\r\n', LineText);
