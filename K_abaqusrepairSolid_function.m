...
function [] = K_abaqusrepairSolid_function(flag, layup,t_Hres,t_overmat,E1UD,E1BIAX,E2UD,E2BIAX,E3UD,E3BIAX,V12UD,V12BIAX,V13UD,V13BIAX,V23UD,V23BIAX,G12UD,G12BIAX,G13UD,G13BIAX,G23UD,G23BIAX,first_Step,Tperiod,Min_incr,Max_incr,Viscosity,E1RESIN,V12RESIN)
...
LineText = '**--------------------------------------'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Element, type=CPE4, Elset=Einterface'; 
fprintf(fileID, '%s\r\n', LineText); 
...
if mat_change == 1  
    ...
    LineText = '**--------------------------------------'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineTextloop = '*Element, type=CPE4, Elset=ErepairUD1';%before ...UD1
    fprintf(fileID, '%s\r\n', LineTextloop);
    ...
    LineText = '**--------------------------------------'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineTextloop = '*Element, type=CPE4, Elset=ErepairBIAX1';%...BIAX1
    fprintf(fileID, '%s\r\n', LineTextloop);
...
%                 if over_lam == 1 && t_overmat == biax
%                 LineText = '** Section: Section-5-Eoverlam';%section 5 
%                 LineText = '*Solid Section, elset=Eoverlam, orientation=Ori-8, material=BIAXMATERIAL'; 
%                 else if over_lam == 1 && t_overmat == ud
%                 LineText = '** Section: Section-5-Eoverlam';%section 5
%                 LineText = '*Solid Section, elset=Eoverlam, orientation=Ori-8, material=UDMATERIAL'; 
...
%                 end
                ...
                LineText = '3, 0.'; 
                fprintf(fileID, '%s\r\n', LineText);
                LineText = '** Section: Section-2-EPARENTBIAX'; %section 2
                fprintf(fileID, '%s\r\n', LineText); 
                LineText = '*Solid Section, elset=EPARENTBIAX, orientation=Ori-4, material=BIAXMATERIAL'; 
                fprintf(fileID, '%s\r\n', LineText); 
                LineText = ','; 
                ...
                LineText = '3, 0.'; 
                fprintf(fileID, '%s\r\n', LineText);
                LineText = '** Section: Section-5-EINTERFACE'; %section 5
                fprintf(fileID, '%s\r\n', LineText); 
                LineText = '*Solid Section, elset=EINTERFACE, orientation=Ori-2, material=RESIN'; 
                fprintf(fileID, '%s\r\n', LineText); 
                ...
                LineText = '3, 0.'; 
                fprintf(fileID, '%s\r\n', LineText);
                LineText = '** Section: Section-6-ERESIN'; %section 6
                fprintf(fileID, '%s\r\n', LineText);
                LineText = '*Solid Section, elset=ERESIN, orientation=Ori-3, material=RESIN'; 
                fprintf(fileID, '%s\r\n', LineText); 
                ...
                LineText = '3, 0.'; 
                fprintf(fileID, '%s\r\n', LineText); 
                LineText = '** Section: Section-4-EREPAIRBIAX'; %section 4
                fprintf(fileID, '%s\r\n', LineText); 
                LineText = '*Solid Section, elset=EREPAIRBIAX, orientation=Ori-6, material=BIAXMATERIAL'; 
                fprintf(fileID, '%s\r\n', LineText); 
                LineText = ','; 
