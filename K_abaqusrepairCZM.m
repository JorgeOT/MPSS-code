...
if mat_change == 1  
    ...
    LineText = '**--------------------------------------'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineTextloop = '*Element, type=CPE4, Elset=ErepairUD1';%it was UD1
    fprintf(fileID, '%s\r\n', LineTextloop);
    ...
    LineText = '**--------------------------------------'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineTextloop = '*Element, type=CPE4, Elset=ErepairBIAX1';%it was ...BIAX1
    fprintf(fileID, '%s\r\n', LineTextloop);
...
if (flag==0)
    ...
    LineText = '**--------------------------------------'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineTextloop = '*Element, type=CPE4, Elset=ErepairBiax';%it was ...biax in small letters
    fprintf(fileID, '%s\r\n', LineTextloop); 
    for m = 1:length(Node_Reploc)
        for n  = 1:length(Node_Reploc{m,1})
            % Layer name
    ...
    for m = 1:length(Node_Reploc)
        ...
        LineText = '**--------------------------------------'; 
        fprintf(fileID, '%s\r\n', LineText);
        LineTextloop = '*Element, type=CPE4, Elset=ErepairBiax';% it was ...Biax before
        fprintf(fileID, '%s\r\n', LineTextloop); 
        for m = 1:length(Node_Reploc)
            for n  = 1:length(Node_Reploc{m,1})
                % Layer name
...
if (mat_change == 1) && (flag==0)
    ...
    LineText = '3, 0.'; 
    fprintf(fileID, '%s\r\n', LineText);
    LineText = '** Section: Section-3-EREPAIRBIAX1'; %there was a BIAX1
    fprintf(fileID, '%s\r\n', LineText);
    LineText = '*Solid Section, elset=EREPAIRUD1, orientation=Ori-7, material=BIAXMATERIAL'; %it was ...UD1
    fprintf(fileID, '%s\r\n', LineText);
    LineText = ','; 
    ...
    LineText = '3, 0.'; 
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = '** Section: Section-4-EREPAIRUD1';%it was UD1 
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = '*Solid Section, elset=EREPAIRBIAX1, orientation=Ori-6, material=UDMATERIAL'; %it was BIAX1
    fprintf(fileID, '%s\r\n', LineText); 
    LineText = ','; 
    fprintf(fileID, '%s\r\n', LineText);
