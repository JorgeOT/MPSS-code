...
function [x_store, y_store, x, yhat] = B_peakfitting_for_GUI(flag, Wrinkle, Nber_defect, disc_density, centre_guess, sigma_guess, amplitude_guess, layup_defect, t_Hres)
