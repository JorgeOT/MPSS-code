...
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Enrichment, name=Crack-3, type=PROPAGATION CRACK, elset=REPAIREDPANEL-1.EREPAIRBIAX'; %1
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Enrichment, name=Crack-4, type=PROPAGATION CRACK, elset=REPAIREDPANEL-1.EREPAIRUD'; %1
fprintf(fileID, '%s\r\n', LineText);
else
...
LineText = '*Enrichment, name=Crack-2, type=PROPAGATION CRACK, elset=REPAIREDPANEL-1.EPARENTUD'; 
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Enrichment, name=Crack-3, type=PROPAGATION CRACK, elset=REPAIREDPANEL-1.EREPAIRBIAX1'; %1
fprintf(fileID, '%s\r\n', LineText);
LineText = '*Enrichment, name=Crack-4, type=PROPAGATION CRACK, elset=REPAIREDPANEL-1.EREPAIRUD1'; %1
fprintf(fileID, '%s\r\n', LineText);
...
fprintf(fileID, '%s\r\n', LineText);
        ...
        fprintf(fileID, '%s\r\n', LineText);
        if (mat_change == 0)
            LineText = '*Enrichment, name=Crack-3, type=PROPAGATION CRACK, elset=REPAIREDPANEL-1.EREPAIRUD';
            fprintf(fileID, '%s\r\n', LineText);
        end
        if(mat_change == 1)
            LineText = '*Enrichment, name=Crack-3, type=PROPAGATION CRACK, elset=REPAIREDPANEL-1.EREPAIRUD1';
            fprintf(fileID, '%s\r\n', LineText);
            LineText = '*Enrichment, name=Crack-5, type=PROPAGATION CRACK, elset=REPAIREDPANEL-1.Eresinrich'; 
            fprintf(fileID, '%s\r\n', LineText);
        end
